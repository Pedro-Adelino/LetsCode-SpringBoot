...
public class UserServiceImpl implements UserDetailsService {
    ...
    // Implementacao da mesma, utilizando o DAO da aplicacao (credenciais salvas no
    // banco);
    @Override
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        return new UserPrincipalDetails(cliente); // Retornando somente o que é importante para a autenticação.
    }
